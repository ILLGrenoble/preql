...
@DisplayName("Long parameter parser tests")
class LongParameterParserTest {
    private final LongParameterParser parser = new LongParameterParser();

    @Test
    @DisplayName("should successfully convert valid values")
    void valid() {
        final LongParameterParser parser = new LongParameterParser();
